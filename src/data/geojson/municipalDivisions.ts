...
export const MUNICIPAL_DIVISIONS_REGISTRY: Record<string, MunicipalDivisionEntry> = {
  ...
  bello: {
    ...
    divisionLabel: '10 comunas urbanas', subdivisionLabel: '132 barrios',
    fuente: 'Alcaldía de Bello - barrios del POT (Acuerdo 033 de 2009), datos.gov.co pnhh-ccwd; comuna de cada barrio según capa Admin_Comunas (EAFIT, 2023)',
    confianza: 'por verificar', disponible: true, nivelComunas: true,
    nota: 'Barrios oficiales. La asignación a comunas es por verificar (24 barrios con asignación parcial o por cercanía). Falta la zona rural (corregimiento San Félix y veredas).',
