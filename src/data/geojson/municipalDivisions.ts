...
export const MUNICIPAL_DIVISIONS_REGISTRY: Record<string, MunicipalDivisionEntry> = {
  ...
  bello: {
    ...
    nota: 'Barrios y comunas oficiales del POT. 123 de 132 barrios caen en una sola comuna; 9 (zonas en desarrollo, industriales y asentamientos de borde) se asignan a la comuna donde está la mayor parte. El plano no nombra las comunas: 1 a 8 y 10 llevan el nombre del mapa de 10 comunas donde coinciden (Niquía se parte en 8 y 9; la 9, 11 y 12 quedan sin nombre). Las 19 veredas se digitalizaron del plano PL14 (10 forman el corregimiento San Félix); el POT deja fuera de sus veredas el sector de Ovejas, que el límite DANE sí incluye.',
