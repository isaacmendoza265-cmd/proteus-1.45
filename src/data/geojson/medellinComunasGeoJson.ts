  ...
  features: [
    ...
    // 80. SAN ANTONIO DE PRADO
    {
      ...
      properties: {
        ...
        population: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].population,
        electoralCensus: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].electoralCensus,
        predominantStratum: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].predominantStratum,
        youthPercentage: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].youthPercentage,
        historicalTurnout: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].historicalTurnout,
        abstentionRate: MEDELLIN_COMUNAS_DATA['med-correg-san-antonio'].abstentionRate,
        winnerParty: 'Creemos',
        winnerCandidate: 'Federico Gutiérrez',
        riskLevel: 'Medio',
        colorCode: '#3b82f6'
